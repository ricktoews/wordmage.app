...
function About(props) {
	...
	<div className="browse-container">
	  ...
	  <div className="about-content">
	      ...
	      <p>Each word entry includes a three-dot menu with options to favorite words you like, mark them for learning, or add tags for organizing your collection.</p>
