	...
	<div className="add-word-container">
	  <div className="add-word-wrapper">
	    <div className="add-word">
	      <h2 className="word">
	        Word Not Listed? Add it!
	      </h2>
	      <div className="word">
	        <input placeholder="Word" onChange={handleWord} type="text" id="new-word" size="20" />
	      </div>
	      <div className={'of-interest'}>
	        <textarea placeholder="Definition" onChange={handleDef} id="new-def" rows="5" />
	      </div>
